...
<body>
    <form action="customer_admin.php<?php if(isset($_REQUEST['page'])){echo "?page=".$_REQUEST['page'];} ?>" method="post"
        ...
        <ul id="slide-out" class="sidenav sidenav-fixed">
            ...
            <li>
                <ul class="collapsible collapsible-accordion">
                    <!-- Profile -->
                    <li><a class="waves-effect" href="customer_admin.php?page=customer_profile.php"><i
                                class="material-icons">art_track</i>Profile</a></li>
                        <!-- Order Menu -->
                    <li><a class="waves-effect" href="customer_admin.php?page=customer_ordermenu.php"><i
                                class="material-icons">shopping_cart</i>Order Details</a></li>
                    <li><a class="waves-effect" href="index.php"><i
                                class="material-icons">dashboard</i>Home Page</a></li>
                </ul>
            </li>
        </ul>
        <!-- <a href="#" data-target="slide-out" class="sidenav-trigger"><i class="material-icons">menu</i></a> -->
