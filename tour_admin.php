...
<body>
    <form action="tour_admin.php<?php if(isset($_REQUEST['page'])){echo "?page=".$_REQUEST['page'];} ?>" method="post"
        enctype="multipart/form-data">
        <!-- Start of Nav Bar -->
        <nav class="light-blue lighten-1 right-content" role="navigation">
            <div class="nav-wrapper ">
                <a id="logo-container" href="#" class="logo-font">Tour Operator</a>
        ...
        <ul id="slide-out" class="sidenav sidenav-fixed">
            ...
            <li>
                <ul class="collapsible collapsible-accordion">
                    <!-- Profile -->
                    <li><a class="waves-effect" href="tour_admin.php?page=tour_profile.php"><i
                                class="material-icons">art_track</i>Profile</a></li>
                    <!-- Order Menu -->
                    <li><a class="waves-effect" href="tour_admin.php?page=customer_ordermenu.php"><i
                                class="material-icons">shopping_cart</i>Order Menu</a></li>
                    <!-- Pak=ckage Menu -->
                    <li><a class="waves-effect" href="tour_admin.php?page=tour_package_menu.php"><i
